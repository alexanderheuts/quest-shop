...
@Mod(value = QuestShop.MODID, dist = Dist.CLIENT)
...
public class QuestShopClient {
    ...
    static void onClientSetup(FMLClientSetupEvent event) {
        ...
        QuestShop.LOGGER.info("HELLO FROM CLIENT SETUP");
        QuestShop.LOGGER.info("MINECRAFT NAME >> {}", Minecraft.getInstance().getUser().getName());
    }
}
