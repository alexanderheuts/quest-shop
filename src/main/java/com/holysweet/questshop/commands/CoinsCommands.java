package com.holysweet.questshop.commands;
    ...
    public static void register(CommandDispatcher<CommandSourceStack> d, CommandBuildContext ctx) {
        ...
        LiteralArgumentBuilder<CommandSourceStack> root = Commands.literal("hqs")
                .then(Commands.literal("coins")
                        ...
                        // /hqs coins add <player> <amount>  (OP only)
                        ...
                        // /hqs coins remove <player> <amount>  (OP only)
                        ...
                        // /hqs coins set <player> <amount>  (OP only)
